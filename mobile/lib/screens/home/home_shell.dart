...
class _HomeShellState extends State<HomeShell> {
  ...
  Future<void> _showCreateChoreSheet({required bool recurring}) async {
    final session = _session;
            ...
            return Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text(
                      recurring ? 'New recurring chore' : 'New chore',
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: Text(
                          recurring ? 'Create recurring chore' : 'Create chore',
                        ),
                      ),
                    ),
                  ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (item.nextDueDate != null)
                      Text('Next due: ${item.nextDueDate}'),
                    Text(
